  <h2 align="center">PROJETO INSTADEV</h2>

  <p align="center">
    Projeto que busca trazer uma rede social <br>semelhante ao Instagram! 📱
    <br />
    <br />
    <br />
  </p>
...
## Traduções 👅
Versão em **Inglês** disponível [aqui](https://github.com/luqonhas/SENAI_SEMESTER1_InstaDev/blob/master/README_en-us.md).
<br>
<br>
...
## Sobre o Projeto 🔍
Nesse projeto foi necessário desenvolver um sistema *WEB*, onde é possível se registrar, logar, deslogar, postar fotos, mudar de nome e deletar a conta do usuário do site, que se tornará a maior rede social dos desenvolvedores nos próximos anos.

Os estudos com este projeto foram iniciados em <ins>**29/01/2021**</ins> e foram finalizados em <ins>**09/02/2021**</ins>.
<br>
<br>
<br>
<div id='process'/>
...
Serão, ao todo, 2 sprints de desenvolvimento:


* _**SPRINT 1 - <ins>FRONT-END**_</ins> 📰<br>
Sprint responsável pelo desenvolvimento da interface do projeto **WEB**, que será desenvolvida por meio do **HTML** e **CSS**, com pequenas participações de **JavaScript**.
